...
const Dashboard = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 page-transition">
      ...
      {/* Filter Modal */}
      {isFilterModalOpen && (
        <div className="fixed inset-0 bg-black/50 z-[60] flex items-center justify-center p-4" onClick={() => setIsFilterModalOpen(false)}>
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md flex flex-col" style={{ maxHeight: '85vh' }} onClick={e => e.stopPropagation()}>
